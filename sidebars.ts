      ...
      items: [
        ...
        'ecc/agents-index',
        {
          ...
          items: [
            ...
            'ecc/agents/tdd-guide',
            'ecc/agents/security-reviewer',
            'ecc/agents/build-error-resolver',
            'ecc/agents/e2e-runner',
            'ecc/agents/architect',
            'ecc/agents/refactor-cleaner',
            'ecc/agents/doc-updater',
            'ecc/agents/loop-operator',
            'ecc/agents/python-reviewer',
            'ecc/agents/go-reviewer',
            'ecc/agents/database-reviewer',
            'ecc/agents/code-explorer',
            'ecc/agents/performance-optimizer',
          ],
        },
